    ...
    navigator.geolocation.getCurrentPosition(
        ...
        error => {
            ...
            if(error.code === error.PERMISSION_DENIED) {
                alert("Geolocation request denied. Please location permission to grant access again.")
            }
        }
    );
}
